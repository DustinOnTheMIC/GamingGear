...
namespace GamingGear.WebForm
{
    public partial class Info : System.Web.UI.Page
    {
        ...
        protected void btnDone_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('Bạn chưa chọn mã đơn hàng')</script>");
            }
        }
        ...
        protected void lbTenHang_Click(object sender, EventArgs e)
        {
            Context.Items["MAHANG"] = ((LinkButton)sender).CommandArgument.ToString();
