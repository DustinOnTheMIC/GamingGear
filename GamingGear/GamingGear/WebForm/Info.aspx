...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="../Css/CssInfo7.css" rel="stylesheet" />
            ...
            <div class="infor-product box left">
                ...
                <table class="table-in-order">
                    <tr>
                        ...
                        <td>
                            <span class="span-btn-all hover-btn button-done-location">
                                <asp:Button ID="btnDone" CssClass="button button-done-size" runat="server" OnClick="btnDone_Click" Text="Have Received" />
                            </span>
                        </td>
                        <td>
                            <span class="span-btn-all hover-btn button-cancel-location">
                                <asp:Button ID="btnCancel" CssClass="button button-cancel-size" runat="server" OnClick="btnCancel_Click" Text="Cancel Order" />
                            </span>
                        </td>
                    </tr>
                </table>
            ...
            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BorderStyle="None" GridLines="None">
                <Columns>
                    <asp:TemplateField HeaderText="Product's Name">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbTenHang" CommandArgument='<%# Eval("MAHANG") %>' OnClick="lbTenHang_Click" runat="server" Text='<%# Eval("TENHANG") %>'></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
