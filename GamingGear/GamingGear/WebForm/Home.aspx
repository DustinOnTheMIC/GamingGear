...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="../Css/cssHome3.css" rel="stylesheet" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class='content-introduce'>
        ...
        <span class="span-btn btn-order">
            <asp:Button ID="btnOrder" OnClick="btnOrder_Click" CssClass="btn-order-all" runat="server" Text="Order Now"/>
        </span>
    </div>
        ...
        <div class="product-head" style="background: url(https://cwsmgmt.corsair.com/landing/slipstream/v3/img/ultra-long-range/ultra-long-range-bg.jpg);">
            ...
            <div class="image">
                ...
                <span class="btn-headphone" >
                    <span class="span-btn btn-order" >
                        <asp:Button ID="btnOrderHeadPhone" OnClick="btnOrderHeadPhone_Click" CommandArgument="4" CssClass="btn-order-all" runat="server" Text="Order Now"/>
                    </span>
                </span>
            </div>
        </div>
    <div class="content-3">
        ...
        <span class="btn-headphone" id="order-monitor" >
                    <span  class="span-btn btn-order" >
                        <asp:Button ID="btnOrderMonitor" OnClick="btnOrderMonitor_Click" CommandArgument="1" CssClass="btn-order-all" runat="server" Text="Order Mornitor"/>
                    </span>
                </span>
        <span class="btn-headphone" id="order-keyboard">
                    <span  class="span-btn btn-order" >
                        <asp:Button ID="btnOrderKeyboard" OnClick="btnOrderKeyboard_Click" CommandArgument="2" CssClass="btn-order-all" runat="server" Text="Order Keyboard"/>
                    </span>
                </span>
        <span class="btn-headphone" id="order-mouse">
                    <span  class="span-btn btn-order" >
                        <asp:Button ID="btnOrderMouse" CssClass="btn-order-all" OnClick="btnOrderMouse_Click" CommandArgument="3" runat="server" Text="Order Mouse"/>
                    </span>
                </span>
    </div>
