...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="../Css/CssProducts10.css" rel="stylesheet" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="center">
        <div class="search-form">
            <asp:TextBox ID="tbSearch" runat="server" class="textbox-search" placeholder="What are you finding..."></asp:TextBox>
            <asp:LinkButton ID="lbtSearch" runat="server" OnClick="lbtSearch_Click" CssClass="linkbutton-search"><i class="fas fa-search"></i></asp:LinkButton>
        </div>
        <div class="product">
                ...
                <ItemTemplate>
                    <div class="product-size">
                        <div class="one-product">
                            <asp:Image ID="Image1" CssClass="image-product" ImageUrl='<%#"~/Images/imageProduct2/"+Eval("HINHANH") %>' runat="server" />
