...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="../Css/CssPayForm3.css" rel="stylesheet" />
</asp:Content>
            ...
            <asp:GridView ID="GridView" CssClass="gridview" GridLines="None" runat="server" AutoGenerateColumns="False" Width="1100px" HorizontalAlign="Center">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Picture">
                        <ItemTemplate>
                            <asp:Image CssClass="imgBill" ID="Image1" ImageUrl='<%#"~/Images/imageProduct2/"+Eval("HINH") %>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
            ...
            <asp:DataList ID="DataList1" Width="100%" runat="server">
                <ItemTemplate>
                    <div class="form1">
                        <div class="rowone">
                            <h5>Address:</h5>
                            <asp:TextBox CssClass="textbox" ID="tbAddress" Text='<%#Eval("DIACHI") %>' runat="server"></asp:TextBox>
                        </div>

                        <div class="rowtow">
                            <h5>Phone Number:</h5>
                            <asp:TextBox CssClass="textbox" ID="tbPhoneNumber" Text='<%#Eval("SDT") %>' runat="server"></asp:TextBox>
                        </div>
                        <div class="rowthree">
                            <h5 style="text-align: left">Note:</h5>
                            <asp:TextBox CssClass="textbox" ID="tbNote" Text="" runat="server"></asp:TextBox>
                        </div>
                        <div class="validator">
                            <div>
