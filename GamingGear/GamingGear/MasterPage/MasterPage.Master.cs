...
namespace GamingGear
{
    public partial class MasterPage : System.Web.UI.MasterPage
    {
        ...
        protected void btnLogin_Click(object sender, EventArgs e) // nút submit trong form đăng nhập
        {
            ...
            {
                lbl.Text = "Sai tên đăng nhập hoặc mật khẩu/ Hoặc có thể tài khoản đã bị khóa";
                return;
            }
            else
            {
        ...
        {
            //Remove cookies
            HttpCookie cookie = HttpContext.Current.Request.Cookies["TENDN"];
            cookie.Expires = DateTime.UtcNow.AddYears(-1);
            HttpContext.Current.Request.Cookies.Remove("TENDN");
            //
